...
// ~3,750 names. Supplemented with a handful of well-known credit unions and
// consumer brands (Discover, Navy Federal, Marcus by Goldman Sachs) that
// either are not FDIC-regulated or operate under a different legal name
// than their brand, so a name a real person would actually type still
// matches. Used to validate + suggest the Bank field - see isKnownBank()
// and the datalist population in app.js, both in loadAccounts().

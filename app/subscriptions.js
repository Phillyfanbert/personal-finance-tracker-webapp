 ...
 * "verify against real edge cases" caution that caught a real bank-name
 * matching bug elsewhere in this codebase. Amount must match exactly
 * rather than fuzzily, since most real bills charge the same amount
 * every cycle.
 *
